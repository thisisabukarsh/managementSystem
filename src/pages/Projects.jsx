      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.totalProjects')}</p>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.inProgress')}</p>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.completed')}</p>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.totalAmount')}</p>
              <h3 className="text-2xl font-bold text-primary mt-1">
                {formatCurrency(projects.reduce((sum, p) => sum + (parseFloat(p.total_amount) || 0), 0), i18n.language)}
              </h3>
            </div>
            <div className="w-12 h-12 rounded-full bg-primary/10 flex items-center justify-center">
              <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-primary">
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.pending')}</p>
              <h3 className="text-2xl font-bold text-yellow-600 mt-1">
                {projects.filter(p => p.status === 'pending').length}
              </h3>
            </div>
            <div className="w-12 h-12 rounded-full bg-yellow-100 flex items-center justify-center">
              <svg width="24" height="24" fill="none" viewBox="0 0 24 24" stroke="currentColor" className="text-yellow-600">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
              </svg>
            </div>
          </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.underDesign')}</p>
              <h3 className="text-2xl font-bold text-purple-600 mt-1">
                {projects.filter(p => p.status === 'under_design').length}
              </h3>
            </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.averageAmount')}</p>
              <h3 className="text-2xl font-bold text-indigo-600 mt-1">
                {formatCurrency(projects.length ? projects.reduce((sum, p) => sum + (parseFloat(p.total_amount) || 0), 0) / projects.length : 0, i18n.language)}
              </h3>
            </div>
        ...
        <div className="bg-white rounded-xl shadow p-6 border border-gray-100">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-500 font-medium">{t('stats.overdue')}</p>
              <h3 className="text-2xl font-bold text-red-600 mt-1">
                {projects.filter(p => {
                  const today = new Date().toISOString().slice(0, 10);
                  return p.delivered_at && p.delivered_at < today && p.status !== 'completed';
                }).length}
              </h3>
            </div>
